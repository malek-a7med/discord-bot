...
const HONEYPOT_CHANNEL_IDS = [
  // ⚠️ "1517362832063074324" كانت متسجلة هنا غلط — دي قناة سجلات
  // الأوتومود/تحديثات الأوامر الحقيقية (مستخدمة في index.js)، مش قناة
  // مصيدة. كانت بتسبب طرد أعضاء عاديين بسبب "بوت أو هاكر" بدون سبب حقيقي.

...
export const LATEST_FEATURES = [
  {
    name: "🔨 قائمة الباند + إيقاف شامل للأوتو مود!",
    value: "**أمر جديد:** `/قائمة-الباند` — شوف كل الأعضاء المتبندين مع السبب والتاريخ [مشرف]\n🛡️ **تحسين الأوتو مود:** لما توقفه بـ `/auto-mod حالة: إيقاف` — كل حاجة بتوقف فعلاً:\nالمسح، الباند، الطرد، الإسكات، الأنتي سبام، الأنتي لينك، الأنتي رايد — 100% وقف!\n✅ الباند بيتسجل تلقائياً في قائمة الباند سواء اتعمل يدوي أو عن طريق الأوتو مود",
    inline: false,
  },
  {

...
export const LATEST_FEATURES = [
  {
    name: "⚠️ نظام التحذيرات اليدوية — متكامل بالكامل!",
    value: "**4 أوامر جديدة للإدارة:**\n📋 `/تحذير-يدوي` — سجّل تحذير يدوي بـ embed احترافي وبيراكم مع تحذيرات الأوتو مود + DM تلقائي للعضو\n📜 `/تحذيرات` — سجل كامل بكل التحذيرات (يدوي + أوتو مود) مع مصدر كل تحذير وتاريخه — بـ pagination\n🗑️ `/مسح-تحذير` — امسح تحذير معين بالرقم [مشرف]\n🧹 `/مسح-كل-التحذيرات` — تصفير كامل لسجل العضو [إدارة]",
    inline: false,
  },
  {
    name: "🎵 نظام موسيقى جديد بالكامل — DisTube!",
    value: "الموسيقى اتبنت من الأول بنظام احترافي!\n🎵 `/شغل` — شغّل أغنية من YouTube أو SoundCloud\n⏭️ `/تخطي` — التالية | ⏸️ `/بوز` — وقف | ▶️ `/كمل` — كمّل\n📋 `/قائمة` — قائمة التشغيل | 🎶 `/شغال-ايه` — الأغنية الحالية\n🔊 `/صوت` — اضبط الصوت | 🔁 `/تكرار` — كرّر أغنية أو القائمة\n→ كمان أزرار تحكم تلقائية مع كل أغنية 🎛️",
    inline: false,
  },
  {
    name: "🔓 رفع الباند + قائمة الباند + إيقاف شامل!",
    value: "**3 أوامر جديدة:**\n🔓 `/رفع-باند` — ارفع الحظر عن عضو بالـ ID وشيله من قائمة الباند تلقائياً [مشرف]\n📋 `/قائمة-الباند` — شوف كل المتبندين مع السبب والتاريخ [مشرف]\n🛡️ `/auto-mod حالة: إيقاف` — بيوقف كل حاجة (مسح، باند، طرد، إسكات، أنتي سبام/لينك/رايد)",
    inline: false,
  },
  {

...
export const LATEST_FEATURES = [
  {
    name: "⚙️ /setup — إعداد شامل + رسايل مخصصة + استقبال تلقائي!",
    value: "لوحة إعداد كاملة من أمر واحد:\n👋 قناة الترحيب والوداع • 📜 قناة السجلات • 🪤 مصيدة الهاكرات\n💬 رسايل ترحيب/وداع مخصصة بـ placeholders: `{mention}` `{user}` `{server}` `{count}`\n🔐 بوابة التحقق • 👮 رتب الإشراف • 🛡️ الأوتو مود الكامل\n📨 البوت دلوقتي بيبعت دليل /setup للأدمن تلقائياً لما يدخل سيرفر جديد",
    inline: false,
  },
  {

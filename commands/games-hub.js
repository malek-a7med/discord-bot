...
export const LATEST_FEATURES = [
  {
    name: "🔍 كاشف الأخطاء — تشخيص شامل للبوت!",
    value: "أمر جديد يفحص البوت من أوله لآخره ويبعت تقرير مفصّل بكل المشاكل!\n✅ فحص الاتصال، الـ AI، قاعدة البيانات، الأوامر، الأزرار، والرومات\n🎮 يعرض حالة كل الألعاب الشغالة والإجراءات المعلّقة\n🔑 يفحص متغيرات البيئة والذاكرة والأداء\n→ `/كاشف-الأخطاء` [أونر فقط]",
    inline: false,
  },
  {
